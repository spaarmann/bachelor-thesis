...
introduced by measurements and present an $O(n^2 \log(n)^c)$ time algorithm that reconstructs the
true clustering with high probability, as well as a heuristic approach based on a similar idea. Many
...
Charikar, Guruswami, and Wirth~\cite{Charikar}, who showed the problem to be APX-hard and gave an
